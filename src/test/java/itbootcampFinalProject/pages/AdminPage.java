...
public class AdminPage extends BasePage{
    ...
    public WebElement getSearchF() {  return getDriver().findElement(searchField);}
    ...
    public WebElement getFirstEditBtn() {  return getDriver().findElement(firstEditBtn);}
    public WebElement getFirstDeleteBtn() {  return getDriver().findElement(firstDeleteBtn);}
